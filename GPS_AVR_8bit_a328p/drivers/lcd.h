...
/**
 @brief    Display a 16-bit integer, handling positive and negative
 @param    int16_t to be displayed, field_length is the num of cols filled
 @return   none
*/
extern void lcd_putui(const int16_t val, const int field_length);
